...
const LoadingScreen = () => {
  ...
  return (
    <section className='relative w-full h-[100vh] flex items-center justify-center flex-col'>
        <CloseButton onClose={handleClose} className='md:block' />
        <img
            src={Popcorn}
            width={480}
            height={180}
            ...
            alt=''
        />
        <p className='text-2xl italic font-light text-center absolute bottom-4 text-white flex items-center gap-3'>
            <LoadingIcon />
            {getRandomPhrase()}
        </p>
    </section>
