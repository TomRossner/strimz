...
> = {
  ...
  hin: { label: 'Hindi', lang: 'hi-IN' },
  fin: { label: 'Finnish', lang: 'fi-FI' },
  isl: { label: 'Icelandic', lang: 'is-IS' },
  nor: { label: 'Norwegian', lang: 'no-NO' },
  swe: { label: 'Swedish', lang: 'sv-SE' },
  dan: { label: 'Danish', lang: 'da-DK' },
  pol: { label: 'Polish', lang: 'pl-PL' },
  ron: { label: 'Romanian', lang: 'ro-RO' },
  bul: { label: 'Bulgarian', lang: 'bg-BG' },
  ell: { label: 'Greek', lang: 'el-GR' },
  hun: { label: 'Hungarian', lang: 'hu-HU' },
  ces: { label: 'Czech', lang: 'cs-CZ' },
  slk: { label: 'Slovak', lang: 'sk-SK' },
  cat: { label: 'Catalan', lang: 'ca-ES' },
  eus: { label: 'Basque', lang: 'eu-ES' },
  srp: { label: 'Serbian', lang: 'sr-RS' },
  hrv: { label: 'Croatian', lang: 'hr-HR' },
  msa: { label: 'Malay', lang: 'ms-MY' },
  tha: { label: 'Thai', lang: 'th-TH' },
  vie: { label: 'Vietnamese', lang: 'vi-VN' },
  ind: { label: 'Indonesian', lang: 'id-ID' },
  ben: { label: 'Bengali', lang: 'bn-BD' },
  tam: { label: 'Tamil', lang: 'ta-IN' },
  ukr: { label: 'Ukrainian', lang: 'uk-UA' },
  fas: { label: 'Persian', lang: 'fa-IR' },
  mon: { label: 'Mongolian', lang: 'mn-MN' },
  sqi: { label: 'Albanian', lang: 'sq-AL' },
  mya: { label: 'Burmese', lang: 'my-MM' },
  tur: { label: 'Turkish', lang: 'tr-TR' },
  kor: { label: 'Korean', lang: 'ko-KR' },
  nld: { label: 'Dutch', lang: 'nl-NL' },
};
